# Compiling snrv's Documentation
...
Once docs built on readthedocs.org, can copy markdown code for badge from project homepage and insert at top of README.md file as link to docs.
